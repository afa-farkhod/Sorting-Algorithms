package org.example.SortingAlgorithms.ExternalSorting;
...
public class SortLargeFile {
    ...
    private static int initializeSegments(int segmentSize, String originalFile, String f1)
        ...
        private static void merge(int numOfSegments, int segmentSize, String f1, String f2, String f3, String targetfile)
            throws Exception{
        if(numOfSegments > 1){
            mergeOneStep(numOfSegments, segmentSize, f1, f2, f3);
            merge((numOfSegments + 1) / 2, segmentSize * 2, f3, f1, f2, targetfile);
        }else{
